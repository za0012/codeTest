...
tanstack query를 공부하는 시간을 가졌다... 근데 더 공부해야할 것 같다.

### 2026.04.16

tanstack query를 추가해주었다.
추가하면서 useEffect도 제거해주고 바꿀 부분은 거의 없었다.
refresh와 관련해서 고민이 많았는데, 해당 라이브러리를 통해 어느 정도 해결할 수 있을 것 같다. 다만 현재 수정부분에서 문제가 있는데, 어떻게 해결해야할지 고민 좀 해야할 것 같다.
